...
def Kit_ladder(L, K_ray, h_ray, BC='periodic'):
...
def Heis_ladder(L, J_ray, h_ray, rung_c = 1.0, BC='periodic'):
...
def KitHeis_ladder(L, J_ray, h_ray, rung_c = 1.0, BC='periodic'):
    ...
    # define static and dynamics lists
    static=[["zz",H_zz_r], ["zz",H_zz_l], ["xx",H_xx_r], ["xx",H_xx_l], , ["xx",H_xx_1], ["xx",H_xx_2], ["yy",H_yy_r], ["yy",H_yy_l], ["yy",H_yy_1], ["yy",H_yy_2], ["z",H_z], ["y",H_y], ["x",H_x]];
    #static=[["zz",H_zz],["z",H_z],["x",H_x]];
    dynamic=[]
    basis=spin_basis_1d(L=2*L)
    H=hamiltonian(static,dynamic,dtype=np.float64,basis=basis,check_herm=False);
